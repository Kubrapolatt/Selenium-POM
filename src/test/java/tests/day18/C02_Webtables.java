...
public class C02_Webtables {
    ...
    public void table(){
        ...
        System.out.println(hmcWebTablePage.tümBodyWebElementi.getText());
        ...
        List<WebElement> bodyTümDataList=hmcWebTablePage.tümBodyDatalarıList;

        System.out.println("body'deki data sayisi : " + bodyTümDataList.size());
    ...
    public void printRows(){
        ...
        // //tbody//tr
        hmcWebTablePage=new HMCWebTablePage();
        System.out.println(hmcWebTablePage.satırlarListesi.size());

        //			○ Table body’sinde bulunan satirlari(rows) konsolda yazdırın.

        List <WebElement> satırlarWebelementListesi=hmcWebTablePage.satırlarListesi;
        for (WebElement each: satırlarWebelementListesi
        ) {
            System.out.println(each.getText());
        }
        //			○ 4.satirdaki(row) elementleri konsolda yazdırın.
        System.out.println("4.satir : "+satırlarWebelementListesi.get(3).getText());
    }
}
